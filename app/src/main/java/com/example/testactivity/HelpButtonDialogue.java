...
public class HelpButtonDialogue extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage("Welcome to Wordle Coach!\n\n" +
                        "This app is designed to be used in tandem with an ongoing Wordle game open in a web browser.\n\n" +
                        ...
                        "Coach app, then select the colors for each letter as displayed on your browser by long pressing" +
                        "on each letter. Then, hit enter.\n\n" +
